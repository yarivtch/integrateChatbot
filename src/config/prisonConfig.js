import { 
    Building, FileText, Users, Calendar, 
    Package, Briefcase, ShoppingCart, 
    FileQuestion, Phone 
} from 'lucide-react';
...
const prisonCategories = [
        ...
        { 
          ...
          //  icon: <Calendar className="w-5 h-5" />,
            intent: 'delayed_imprisonment'
        },
        { 
            title: 'ציוד מותר',
           // icon: <Package className="w-5 h-5" />,
            intent: 'allowed_equipment'
        },
        { 
            title: 'שיקום ותעסוקה',
          //  icon: <Briefcase className="w-5 h-5" />,
            intent: 'rehabilitation_employment'
        },
        { 
            title: 'קנטינה מקוונת',
         //   icon: <ShoppingCart className="w-5 h-5" />,
            intent: 'online_canteen'
        },
        { 
            title: 'בקשות מיוחדות',
...
export const prisonKnowledgeBase = {
    "about_ips": {
...
export const prisonConfig = createBaseConfig('prison', {
    name: "צ'ט מידע ",
    language: "he",
    categories: prisonCategories,
    knowledgeBase: prisonKnowledgeBase,
    sqlConfig: {
        apiUrl: 'http://localhost:5000/api/query',  // יעודכן לפי הפורט האמיתי
